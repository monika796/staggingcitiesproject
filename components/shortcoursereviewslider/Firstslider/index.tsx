  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setPosts(data?.page?.shortCourseFields?.shortCoursesSixthSection?.shortCoursesSixthSectionFirstReviewRow || [])
      } catch (error) {
                  ...
                  <div className="flex mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-[14px] text-[#000] ">
                        {testimonial.shortCoursesSixthSectionReviewFirstUserStatus}
                      </p>
                    </div>
                  </div>
